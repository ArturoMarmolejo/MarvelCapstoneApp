...
import com.arturomarmolejo.marvelcapstoneapp.databinding.EventItemByCharacterBinding
...
class EventListByCharacterAdapter(
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): EventListByCharacterViewHolder {
        return EventListByCharacterViewHolder(
            EventItemByCharacterBinding.inflate(
...
class EventListByCharacterViewHolder(
    private val binding: EventItemByCharacterBinding
